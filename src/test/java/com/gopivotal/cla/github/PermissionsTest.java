...
public final class PermissionsTest extends AbstractGitHubTest<Permissions> {
    ...
    @Override
    protected void assertEqualsAndHashCode(EqualsAndHashCodeTestUtils<Permissions> instance) {
        // @formatter:off
        instance
